...
first_1000_vocab020 = new first_1000_vocab(020,"居る","to be, to have (about human beings and animals)","iru","Ichidan Verb, Intransitive","いる","day 2","家に猫が居ます。/ いえにねこがいます。/ Ie ni neko ga imasu./ There is a cat at home.",1,"ir");
...
first_1000_vocab156 = new first_1000_vocab(156,"着る","to wear","kiru","Ichidan Verb, Transitive","きる","clothing","今日はスーツを着ます。/ きょうはスーツをきます。/ Kyō wa sūtsu o kimasu. / Today, I will wear a suit.",1,"kir");
...
first_1000_vocab168 = new first_1000_vocab(168,"締める","to tie; to fasten; to tighten​","shimeru","Ichidan Verb, Transitive","しめる","clothing","ベルトを締めてください。/ べるとをしめてください。/ Beruto o shimete kudasai. / Please fasten your belt.",1,"shimer");
...
first_1000_vocab209 = new first_1000_vocab(209,"上げる","to raise; to elevate","ageru","Ichidan Verb, Transitive","あげる","directions","その荷物を上げてください。/ そのにもつをあげてください。/ Sono nimotsu o agete kudasai. / Please lift that luggage.",1,"ager");
...
first_1000_vocab274 = new first_1000_vocab(274,"食べる","to eat","taberu","Ichidan Verb, Intransitive","たべる","Food 3","昼ご飯にカレーライスを食べました。/ ひるごはんにかれーらいすをたべました。/ Hirugohan ni karee raisu o tabemashita. / I had curry rice for lunch.",1,"taber");
...
first_1000_vocab316 = new first_1000_vocab(316,"借りる","to borrow","kariru","Ichidan Verb, Transitive","かりる","home","友達から本を借りました。/ ともだちからほんをかりました。/ Tomodachi kara hon o karimashita. / I borrowed a book from a friend.",1,"kair");
...
first_1000_vocab325 = new first_1000_vocab(325,"寝る","to sleep; to go to bed; to lie down","neru","Ichidan Verb, Intransitive","ねる","home","疲れたので寝る準備をします。/ つかれたのでねるじゅんびをします。/ Tsukareta node neru junbi o shimasu. / I'm tired, so I'll prepare to sleep.",1,"ner");
...
first_1000_vocab338 = new first_1000_vocab(338,"閉める","to close; to shut","shimeru","Ichidan Verb, Transitive","しめる","home","ドアを閉めて外の音を遮りましょう。/ ドアをしめてそとのおとをさえぎりましょう。/ Doa o shimete soto no oto o saegirimashou. / Let's close the door to block out the outside noise.",1,"shimer");
...
first_1000_vocab386 = new first_1000_vocab(386,"出る","to leave; to exit; to appear; to go out","deru","Ichidan Verb, Intransitive","でる","map","家を出て学校に向かいました。/ いえをでてがっこうにむかいました。/ Ie o dete gakkou ni mukaimashita. / I left home and headed to school.",1,"der");
...
first_1000_vocab390 = new first_1000_vocab(390,"入れる","to put in; to let in; to take in; to bring in; to insert; to install","ireru","Ichidan Verb, Transitive","いれる","map","カバンに本を入れました。/ かばんにほんをいれました。/ Kaban ni hon o iremashita. / I put books in my bag.",1,"irer");
...
first_1000_vocab419 = new first_1000_vocab(419,"答える","to answer","kotaeru","Ichidan Verb, Intransitive","こたえる","people","質問に正しく答えました。/ しつもんにただしくこたえました。/ Shitsumon ni tadashiku kotaemashita. / I answered the question correctly.",1,"kotaer");
...
first_1000_vocab441 = new first_1000_vocab(441,"教える","to teach","oshieru","Ichidan Verb, Transitive","おしえる","school","先生が新しい言葉を教えてくれました。/ せんせいがあたらしいことばをおしえてくれました。/ Sensei ga atarashii kotoba o oshiete kuremashita. / The teacher taught me new words.",1,"oshier");
...
first_1000_vocab471 = new first_1000_vocab(471,"開ける","to open (a door, etc.); to unwrap (e.g. parcel, package); to unlock","akeru","Ichidan Verb, Transitive","あける","shopping","ドアを開けて部屋に入りました。/ ドアをあけてへやにはいりました。/ Doa o akete heya ni hairimashita. / I opened the door and entered the room.",1,"aker");
...
first_1000_vocab517 = new first_1000_vocab(517,"降りる","to get off","oriru","Ichidan Verb, Intransitive","おりる","travel","バスから降りる前にベルを押してください。/ バスからおりるまえにベルをおしてください。/ Basu kara oriru mae ni beru o oshite kudasai. / Please press the bell before getting off the bus.",1,"oir");
...
first_1000_vocab528 = new first_1000_vocab(528,"晴れる","to be sunny","hareru","Ichidan Verb, Intransitive","はれる","weather","雨がやんで晴れました。/ 雨がやんで晴れました。/ Ame ga yande hare mashita. / The rain has stopped and it's sunny now.",1,"harer");
...
first_1000_vocab571 = new first_1000_vocab(571,"起きる","to get up; to wake up","okiru","Ichidan Verb, Intransitive","おきる","home","毎朝、早く起きることができます。/ まいあさ、はやくおきることができます。/ Maiasa, hayaku okiru koto ga dekimasu. / I can wake up early every morning.",1,"okir");
...
first_1000_vocab584 = new first_1000_vocab(584,"付ける","to attach; affix; add; apply","tsukeru","Ichidan Verb, Transitive","つける","work","ライトを付けてください。/ らいとをつけてください。/ Raito o tsukete kudasai. / Please turn on the light.",1,"tsuker");
...
first_1000_vocab586 = new first_1000_vocab(586,"勤める","to work for someone","tsutomeru","Ichidan Verb, Transitive","つとめる","work","彼は会社で勤めています。/ かれはかいしゃでつとめています。/ Kare wa kaisha de tsutomete imasu. / He works at the company.",1,"tsumer");
...
first_1000_vocab589 = new first_1000_vocab(589,"並べる","to line up,to set up","naraberu","Verb, Ichidan Verb, Transitive verb","ならべる","work","本を並べることが好きです。/ ほんをならべることがすきです。/ Hon o naraberu koto ga suki desu. / I enjoy arranging books.",1,"naraber");
...
first_1000_vocab599 = new first_1000_vocab(599,"消える","to disappear","kieru","Ichidan Verb, Intransitive","きえる","time","ライトが突然消えました。/ ライトがとつぜんきえました。/ Raito ga totsuzen kiemashita. / The light suddenly went out.",1,"kier");
...
first_1000_vocab615 = new first_1000_vocab(615,"見る","to see; to look; to watch; to view; to observe","miru","Ichidan Verb, Transitive","みる","shopping","映画を見ます。/ えいがをみます。/ eiga o mimasu. / I watch movies.",1,"mir");
first_1000_vocab616 = new first_1000_vocab(616,"見せる","to show; to display (relared to shop?)","miseru","Ichidan Verb, Transitive","みせる","shopping","私は彼に写真を見せました。/ わたしはかれにしゃしんをみせました。/ watashi wa kare ni shashin o misemashita. / I showed him the photo.",1,"miser");
...
first_1000_vocab625 = new first_1000_vocab(625,"覚える","to remember","oboeru","Ichidan Verb, Transitive","おぼえる","14","彼は新しい言葉をすぐに覚えます。/ かれはあたらしいことばをすぐにおぼえます。/ kare wa atarashii kotoba o sugu ni oboemasu. / He quickly memorizes new words.",1,"oboer");
...
first_1000_vocab643 = new first_1000_vocab(643,"生まれる","to be born","umareru","Ichidan Verb, Intransitive","うまれる","2","彼女は東京で生まれました。/ かのじょはとうきょうでうまれました。/ Kanojo wa Tōkyō de umaremashita. / She was born in Tokyo.",1,"umarer");
...
first_1000_vocab647 = new first_1000_vocab(647,"忘れる","to forget","wasureru","Ichidan Verb, Transitive","わすれる","","忘れ物をしました。/ わすれものをしました。/ Wasuremono o shimashita. / I forgot something.",1,"wasurer");
