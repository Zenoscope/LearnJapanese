...
function_execute_script("scr_VocabList");
temp = global.roomBreadcrumbs[array_length(global.roomBreadcrumbs) - 3]
switch (global.roomBreadcrumbs[array_length(global.roomBreadcrumbs) - 3]){
		case "Kanji":
