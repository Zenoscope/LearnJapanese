...
if (clicked)
	...
	if (room_script.moving == false ) {
		...
		if (btn_name == "ArrowLeft" && room_script.card_index <= (array_length(room_script.kanji_list) - 1) ){//3
			...
			//function_spawn_kanji_card(x_loc ,y_loc / 2 ,room_script ,card_index ,"field_4");
